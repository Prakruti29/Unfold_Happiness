...
<!-- Mirrored from resources/shop-product-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Jan 2020 07:48:57 GMT -->
<head>
...
<div id="wrapper" class="clearfix">
  ...
  <div class="main-content">
    ...
    <section class="inner-header divider parallax layer-overlay overlay-white-8" data-bg-img="/unfoldhappiness_volunteer/resources/images/purse.jpgimages/bg/bg6.jpg">
            ...
            <div class="product">
              <div class="col-md-5">
                <div class="product-image">
                  ...
                  <li data-thumb="placehold.it/750x750"><a href="placehold.it/750x750.jpg" data-lightbox="single-product"><img src="/unfoldhappiness_volunteer/resources/images/purse.jpg" alt=""></a></li>
                  <li data-thumb="placehold.it/750x750"><a href="placehold.it/750x750.jpg" data-lightbox="single-product"><img src="/unfoldhappiness_volunteer/resources/images/purse.jpg" alt=""></a></li>
                  <li data-thumb="placehold.it/750x750"><a href="placehold.it/750x750" data-lightbox="single-product"><img src="/unfoldhappiness_volunteer/resources/images/purse.jpg" alt=""></a></li>
                </ul>
                </div>
              </div>
              <div class="col-md-7">
                <div class="product-summary">
                  <h2 class="product-title">Hand Stiched Purse</h2>
                  <div class="price"> <del><span class="amount">Rs500.00</span></del> <ins><span class="amount">Rs400.00</span></ins> </div>
                  <div class="short-description">
                    <p>Hand Stiched purse for Women which can be used on daily basis and which go with casual clothes</p>
                  </div>
                  ...
                  <div class="cart-form-wrapper mt-30">
                    <form enctype="multipart/form-data" method="post" class="cart">
                      ...
                      <a href="cart.jsp" class="single_add_to_cart_button btn btn-default">Add to cart</a>
                    </form>
                  </div>
                </div>
              </div>
              ...
              <div class="products related owl-carousel-4col" data-nav="true">
                <div class="item">
                  <div class="product">
                    ...
                    <div class="product-thumb"> <img alt="" src="placehold.it/260x194" class="img-responsive img-fullwidth">
                    ...
                    <div class="product-details text-center">
                      ...
                      <div class="price"><del><span class="amount">Rs520.00</span></del><ins><span class="amount">$480.00</span></ins></div>
...
<!-- Mirrored from resources/shop-product-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Jan 2020 07:50:01 GMT -->
</html>