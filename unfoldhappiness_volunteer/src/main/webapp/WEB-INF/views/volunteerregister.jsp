        ...
        <div class="row">
          <div class="col-md-6 col-md-push-3">
            <div class="border-1px p-30 mb-0">
              ...
              <form id="job_apply_form" name="job_apply_form" action="volHome.jsp" method="post" enctype="multipart/form-data">
                <div class="row">
                  <div class="col-sm-12">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input name="photo" class="file" type="file" multiple data-show-upload="false" data-show-caption="true" required="true">
                  <small>Maximum upload file size: 12 MB</small>
                </div>
                <div class="form-group">
                  <label>Photo ID Proof Upload<small>*</small></label>
                  <input name="proof" class="file" type="file" multiple data-show-upload="false" data-show-caption="true" required="true">
                  <small>Maximum upload file size: 12 MB</small>
                </div>
               
                <label>Preferrable Time:<small>*</small></label>  

    <div class="row">
        <div class='col-sm-12'>
            <div class="form-group">
                <div class='input-group date' id='datetimepicker3' name="time">
                    <input name="form_time" type="text" placeholder="Enter preferable time" required="" class="form-control">
                    <span class="input-group-addon">
                ...
                <div class="form-group">
                  ...
                  <button type="submit" class="btn btn-block btn-dark btn-theme-colored btn-sm mt-20 pt-10 pb-10">Apply Now</button>
                </div>
              </form>
              <!-- Job Form Validation-->
