        ...
        <div class="row">
          <div class="col-md-6 col-md-push-3">
            <div class="border-1px p-30 mb-0">
              <h3 class="text-theme-colored mt-0 pt-5">EDIT PROFILE</h3>
              <hr>
              ...
              <form id="job_apply_form" name="job_apply_form" action="http://resources/includes/job.php" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <input name="dob" class="form-control required " type="text" placeholder="Enter Date of Birth">
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <button type="submit" class="btn btn-block btn-dark btn-theme-colored btn-sm mt-20 pt-10 pb-10" data-loading-text="Please wait...">EDIT PROFILE</button>
                </div>
              </form>
              <!-- Job Form Validation-->
