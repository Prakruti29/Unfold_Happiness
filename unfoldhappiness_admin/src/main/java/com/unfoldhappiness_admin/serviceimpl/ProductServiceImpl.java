...
import com.unfoldhappiness_admin.dao.ProductDao;
import com.unfoldhappiness_admin.model.Admin;
import com.unfoldhappiness_admin.model.Product;
import com.unfoldhappiness_admin.service.ProductService;
...
public class ProductServiceImpl implements ProductService {
	...
	private static String UPLOADED_FOLDER1 ="H:\\Tools\\Tomcat 9.0\\webapps\\unfoldhappiness_admin\\resources\\images\\product\\photo1"+File.separator; 
	private static String UPLOADED_FOLDER2 ="H:\\Tools\\Tomcat 9.0\\webapps\\unfoldhappiness_admin\\resources\\images\\product\\photo2"+File.separator;
	...
	public long addProduct(Product product, MultipartFile file1, MultipartFile file2) {
		...
		product.setCreatedBy(ad.getId());
		product.setModifyBy(ad.getId());
