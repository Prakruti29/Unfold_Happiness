                    ...
                    <div class="row">
                            <div class="col-md-12">
                                <div class="form-group label-floating">
                                    ...
                                    pattern="[a-zA-Z][a-zA-Z ]{1,}" required="true" />
                                </div>
                            </div>
                                                   </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group label-floating">
                                    ...
                                    <form:input type="email" class="form-control" name="email" path="email" required="true"/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group label-floating">
                                    ...
                                    <br>
                                    <form:textarea rows="4" cols="35" name="address" path="address" required="true"/>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group label-floating">
                                    ...
                                    <form:input type="text" class="form-control" name="mobileno" path="mobileno" required="true" pattern="[0-9]{10}"/>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group label-floating">
                            ...
                            <div class="col-md-12">
                                <div class="form-group label-floating">
                                    ...
                                    <div class="radio">
									<label>
										<form:radiobutton  name="gender" checked="true" path="gender" value="Male"/>
										Male
									</label>
									<label>
                       ...
                       <c:choose>
												<c:when test="${edit}">
													<input type="submit" class="btn btn-rose btn-fill"
														value="Update" formaction="/unfoldhappiness_admin/user/editSave"/>
												</c:when>
												<c:otherwise>
													<input type="submit" class="btn btn-rose btn-fill"
														value="Register" formaction="/unfoldhappiness_admin/user/saveUser"/>
												</c:otherwise>
											</c:choose>
                    </form:form>
                </div>
