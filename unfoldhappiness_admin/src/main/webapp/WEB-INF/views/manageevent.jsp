...
<%@include file="admin_sidebar.jsp" %>
	...
	<div class="col-md-12">
            <div class="card">
                ...
                <a href="/unfoldhappiness_admin/event/addEvent">
                        ...
                        <table class="table">
                           ...
                           <c:forEach items="${eventList}" var="event">
                                <tr>
                                    ...
                                    <td><c:out value="${event.e_name}"/></td>
                                    <td><c:out value="${event.e_venue}"/></td>
                                    <td class="td-actions text-right">
                                     <a href="viewEvent/<c:out value='${event.id }'/>">
                                        <button type="button" rel="tooltip" class="btn btn-info">
                                            <i class="material-icons">person</i>
                                        </button>
                                        </a>
                                     <a href="editEvent/<c:out value='${event.id }'/>">
                                         <button type="button" rel="tooltip" class="btn btn-success">
                                            <i class="material-icons">edit</i>
                                        </button>
                                        </a>
                                     <a href="deleteEvent/<c:out value='${event.id}'/>">
