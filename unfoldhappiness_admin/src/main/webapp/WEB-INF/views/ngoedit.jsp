                ...
                <div class="card-content">
                    ...
                    <form disabled="disabled">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group label-floating">
                                    <label class="id1">Area:-</label>
                                    <select name="area">
                                    <option value="Vasna">Vasna
                                    <option value="Paldi">Paldi
                                    <option value="Prahladnagar">Prahladnagar
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group label-floating">
                                    <label class="id1">Phone Number</label>
                                    <input type="text" class="form-control" >
                                </div>
                            </div>
						<div class="col-md-12">
                                <div class="form-group label-floating">
                                    <label class="id1">Email</label>
                                    <input type="email" class="form-control" >
                                </div>
                            </div>  
                            <div class="col-md-12">
                                <div class="form-group label-floating">
                                    <label class="id1">Password</label>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group label-floating">
                                    <label class="id1">Date of Establishment</label>
                                    <input type="text" class="form-control" >
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group label-floating">
                                    <label class="id1">Services</label>
                                   <div class="checkbox">
									<label>
                        ...
                        <center><button type="submit" class="btn btn-rose btn-fill">Update</button></center>
                    </form>
                </div>
            </div>
        </div>
