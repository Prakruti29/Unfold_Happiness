        ...
        <div class="col-md-10" >
            <div class="card" >
                ...
                <div class="card-content">
                    <strong><h4 class="card-title" id="h1">Admin Details </h4></strong>

                    <form:form modelAttribute="admin" enctype="multipart/form-data" disabled="true">
                    <center>
                    <div class="col-md-3 col-sm-4" id="d1">
							...
							<div class="fileinput fileinput-new text-center"
											...
											<div class="fileinput-new thumbnail img-circle">
												<img
													src="/unfoldhappiness_admin/resources/images/admin/profileImage/${admin.photo}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group label-floating">
                                    ...
                                    <form:input type="text" class="form-control" path="dob" disabled="true" value="12-04-1995" />
                                </div>
                            </div>
                            </div>
							<div class="row">
