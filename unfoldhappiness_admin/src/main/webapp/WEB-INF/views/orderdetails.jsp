        ...
        <div class="col-md-4" >
            <div class="card"  id="c1">
                ...
                <div class="card-content">
                    <strong><h4 class="card-title" id="p1"><u>NGO Details </u></h4></strong>
            ...
            <div class="card" id="z1">
                ...
                <div class="card-content">
                    <h4 class="card-title" id="p1"><u>Product Details</h4></u>
                    <div class="table-responsive">
                        <table class="table" id="t1">
                            ...
                            <tbody>
                                <tr>
                                    <td id="p1">Product ID</td> 
                                    <td>101</td>
                                    
                                </tr>
                             <tr>
                                    <td id="p1">Product Name</td>
                                    <td>Purse</td>
                                 
                                </tr>
                                <tr>
                                    <td id="p1">Product Price</td>
                                    <td>2000.RS</td>
                                 
                                </tr>
                                <tr>
                                    <td id="p1">Product type</td>
                                    <td>Accessory</td>
                                   
                                </tr>
                                <tr>
                                    <td id="p1">Product Quantity</td>
                                    <td>2	</td>
