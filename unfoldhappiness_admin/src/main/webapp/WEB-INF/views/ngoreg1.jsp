        ...
        <div class="col-md-10" >
            <div class="card" id="d1">
                ...
                <div class="card-content">
                    <h4 class="card-title">NGO Registration </h4>
                    ...
                    <form>
                        ...
                        <center><button type="submit" class="btn btn-rose btn-fill">ADD NGO</button></center>
                    </form>
                </div>
            </div>
        </div>
...
document,'script','resources/js/fbevents.js');
