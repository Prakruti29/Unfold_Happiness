...
<body data-image="/unfoldhappiness_admin/resources/img/login.jpeg">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3">
                        ...
                        <form method="post" action="/unfoldhappiness_admin/admin/loggingIn" modelAttribute="log">
                            <div class="card card-login card-hidden">
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="form-group label-floating">
                                            ...
                                            <input type="password" name="password" path="password" class="form-control"/>
                                        </div>
                                    </div>
                                ...
                                <div class="footer text-center">
									...
									<br>
									<a href="/unfoldhappiness_admin/admin/forgotPassword"><label class="control-label" style="color:#ec407a">Forgot Password ?</label></a>
                                </div>
                            </div>
                        </form>
