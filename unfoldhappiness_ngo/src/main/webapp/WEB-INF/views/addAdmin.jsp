                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group label-floating">
                                    ...
                                    <br>
                                    <form:textarea  rows="4" cols="35" path="address" name="address"/>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group label-floating">
														...
														</label> <br> <label for="fileupload"> Upload Photo</label>
														<form:input class="form-control" name="profileImage"
															id="profileImage" type="file" required="true" path="profileImage" />
													</div>
                            </div>
                        </div>
                        ...
                        <c:choose>
												<c:when test="${edit}">
													<input type="submit" class="btn btn-rose btn-fill"
														value="Update" formaction="/unfoldhappiness_admin/admin/editAdmin"/>
												</c:when>
												<c:otherwise>
													<input type="submit" class="btn btn-rose btn-fill"
