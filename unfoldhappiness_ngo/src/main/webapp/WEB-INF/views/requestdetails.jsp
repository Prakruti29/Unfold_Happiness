    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li>
                    <a href="adminhome.jsp" class="dropdown-toggle" data-toggle="dropdown">
                       <i class="material-icons">person</i>
                       <p class="hidden-lg hidden-md">Manage Donations</p>
                    </a>
                </li>
        ...
        <div class="col-md-4" >
			...
			<div class="card-content" data-background-color="rose">
		...
		<div id="b1">
            ...
            <div class="card" id="z1">
                ...
                <div class="card-content">
                    <h4 class="card-title" id="p1"><u>Request Details</h4></u>
                    <div class="table-responsive">
                        <table class="table" id="t1">
                            ...
                            <tbody>
                                <tr>
                                    <td id="p1">Request ID</td> 
                                    <td>101</td>
                                    
                                </tr>
                             
                                <tr>
                                    <td id="p1">Request Date</td>
                                    <td>10/11/2020</td>
                                 
                                </tr>
                                <tr>
                                    <td id="p1">Request time</td>
                                    <td>10:00am</td>
...
<div class="content" >
        ...
        <div class="col-md-4" >
            <div class="card"  id="k1">
                ...
                <div class="card-content">
                    <strong><h4 class="card-title" id="p1"><u>Donor Details </u></h4></strong>
                    ...
                    <div class="col-md-3 col-sm-4" id="d1">
							...
							<div class="fileinput fileinput-new text-center" data-provides="fileinput">
								...
								<br>
								<div>
										<strong><legend id="l1">Donor Name</legend></strong>
