                ...
                <div class="card-content">
                    ...
                    <div class="fileinput fileinput-new text-center"
											...
											<div class="fileinput-new thumbnail img-circle">
												<img
													src="/unfoldhappiness_ngo/resources/images/product/photo1/${product.photo1}"
								...
								<div class="fileinput fileinput-new text-center"
											...
											<div class="fileinput-new thumbnail img-circle">
												<img
													src="/unfoldhappiness_ngo/resources/images/product/photo2/${product.photo2}"
													class="picture-src" id="wizardPicturePreview" title="" />
											</div>
                    ...
                    <div class="col-md-3 col-sm-4" id="d1">
								...
								<div>
										<strong>Product Name</strong>
										 <form:input type="text" class="form-control text-center"  path="name"  disabled="true"/>
