        ...
        <div class="collapse navbar-collapse">
            ...
            <form class="navbar-form navbar-right" role="search">
                <div class="form-group form-search is-empty">
                    ...
                    <span class="material-form:input"></span>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group label-floating">
                                    ...
                                    <br>
                                    <form:textarea rows="4" cols="35" name="address" path="address"/>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group label-floating">
                                    ...
                                    <form:input type="text" class="form-control" name="mobileno" path="mobileno"/>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group label-floating">
                       ...
                       <c:choose>
												<c:when test="${edit}">
													<input type="submit" class="btn btn-rose btn-fill"
														value="Update" formaction="/unfoldhappiness_admin/user/editUser"/>
												</c:when>
												<c:otherwise>
													<input type="submit" class="btn btn-rose btn-fill"
