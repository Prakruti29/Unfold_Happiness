				...
				modelAttribute="register" enctype="multipart/form-data" method="post">
                    ...
                    <div class="form-group label-floating" >
                           ...
                           <div class="col-lg-3 col-md-5 col-sm-3">
									...
									data-size="7" name="product_type" path="product_type" >
						...
						<div class="form-group label-floating">
                            ...
                            <form:textarea rows="4" cols="35" name="description" path="description"/>
						...
						<div class="fileinput fileinput-new text-center"
											...
											<c:choose>
												<c:when test="${edit}">
													<img
													src="/unfoldhappiness_ngo/resources/images/product/photo1/${register.photo1}"
                        ...
                        <div class="fileinput fileinput-new text-center"
											...
											<c:choose>
												<c:when test="${edit}">
													<img
													src="/unfoldhappiness_ngo/resources/images/product/photo2/${register.photo2}"
													class="picture-src" id="wizardPicturePreview" title="" />
												</c:when>
												<c:otherwise>
													 <img src="/unfoldhappiness_admin/resources/demos.creative-tim.com/bs3/material-dashboard-pro/assets/img/default-avatar.png"
                        ...
                        <c:choose>
												<c:when test="${edit}">
													<input type="submit" class="btn btn-rose btn-fill"
														value="Update" formaction="/unfoldhappiness_ngo/product/updateProduct"/>
												</c:when>
												<c:otherwise>
													<input type="submit" class="btn btn-rose btn-fill"
														value="Register" formaction="/unfoldhappiness_ngo/product/saveProduct" />
												</c:otherwise>
											</c:choose>
                    </div>
                </form:form>
