...
<body>
								...
								<div class="card">
									<form:form modelAttribute="volregister" enctype="multipart/form-data">
										...
										<div class="card-content">
											...
											<div class="form-group label-floating">
												<label class="id1"> Mobile Number <small>*</small>
												</label> <form:input class="form-control" name="mobnum" id="mobnum"
													path="mobileno" type="text" required="true" />
											</div>
											...
											<div class="form-group label-floating">
												<div class="radio">
													...
													<label class="id1"> Gender <small>*</small>
											...
											<!-- <div class="form-group label-floating">
												...
												<div class="col-lg-3 col-md-5 col-sm-3">
													<select class="selectpicker"
														...
														<option disabled selected>Vansa</option>
														<option value="2">Prahladnagar</option>
 ...
 -->
											...
											<div class="form-group label-floating">
												...
												<br> <label class="id1"> Photo <small>*</small>
												</label> <br> <label for="fileupload"> Upload Photo</label> <input
													class="form-control" name="photo" id="photo"
													path="photo" type="file" required="true" />
											</div>
											<div class="col-md-4">
											...
											<div class="form-group label-floating">
												...
												<br> <label class="id1"> Photo <small>*</small>
												</label> <br> <label for="fileupload"> Upload Identity Proof</label> <input
													class="form-control" name="proof" id="proof"
													path="proof" type="file" required="true" />
											</div>
									</div>
									<br>
									<br>
									...
									<c:choose>
												<c:when test="${edit}">
													<input type="submit" class="btn btn-rose btn-fill"
														value="Update" formaction="/unfoldhappiness_admin/volunteer/volSave"/>
												</c:when>
												<c:otherwise>
													<input type="submit" class="btn btn-rose btn-fill"
