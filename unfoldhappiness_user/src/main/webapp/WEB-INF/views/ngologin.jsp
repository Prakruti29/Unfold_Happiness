      ...
      <div class="container" id="main" >
        <div class="row">
          <div class="col-md-6 col-md-push-2">
           ...
           <center> <p id="reg">New Partner?  &nbsp;&nbsp;&nbsp;<a href="/unfoldhappiness_user/ngo/addNgo" class="text-theme-colored font-weight-600 font-14">REGISTER</a></p></center>
            <form method="post" action="/unfoldhappiness_user/user/ngologgingIn" modelAttribute="log" enctype="multipart/form-data">
              <div class="row" id="u1">
                <div class="form-group col-md-12">
                  <label for="form_username_email">Email</label>
                  <input type="text" name="email" class="form-control" path="email">
                </div>
              </div>
              <div class="row" id="u1">
                <div class="form-group col-md-12">
                  ...
                  <input type="password" name="password" class="form-control" path="password">
                   ...
                   <%if(request.getParameter("errorMsg") != null){ %>
                                ...
                                <%} %>
              <div class="id1">
              	<a class="text-theme-colored font-weight-600 font-12" href="/unfoldhappiness_user/user/ngoforgotPassword">Forgot Your Password?</a>
                </div>
              ...
              <!-- <a href="/unfoldhappiness_user/user/loggingIn" class="btn btn-dark btn-lg btn-block no-border mt-15 mb-15" data-bg-color="darkorange">Login</a><div class="clear text-center pt-10"> -->
              </div>
