...
<!-- Mirrored from resources/shop-checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Jan 2020 07:50:01 GMT -->
<head>
            ...
            <div class="col-md-12 text-center">
              ...
              <div class="col-md-10">
                ...
                <table class="table table-striped table-bordered tbl-shopping-cart">
                  ...
                  <tbody>
                    <tr>
                      <td class="product-thumbnail"><a href="#"><img alt="member" src="placehold.it/255x194"></a></td>
                      <td><a href="#">Winter Black Jacket</a> x 2</td>
                      <td><span class="amount">$36.00</span></td>
                    </tr>
                    <tr>
                      <td class="product-thumbnail"><a href="#"><img alt="member" src="placehold.it/255x194"></a></td>
                      <td><a href="#">Swan Crop V-Neck Tee</a> x 3</td>
                      <td><span class="amount">$115.00</span></td>
                    </tr>
                    <tr>
                      <td class="product-thumbnail"><a href="#"><img alt="member" src="placehold.it/255x194"></a></td>
                      <td><a href="#">Blue Solid Casual Shirt</a> x 1</td>
              ...
              <div class="col-md-10">
               <center> <div class="text-center"> <a class="btn btn-default">Place Order</a> </div></center>
              </div>
            </form>
          </div>
        </div>
