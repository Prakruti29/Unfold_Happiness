        ...
        <div class="row">
          <div class="col-md-6 col-md-push-3">
            <div class="border-1px p-30 mb-0">
              <h3 class="text-theme-colored mt-0 pt-5">Become a Volunteer</h3>
              <hr>
             
             <form:form modelAttribute="volregister" enctype="multipart/form-data">
             <form:hidden path="vol_id" name="id" />
                <div class="row">
                  <div class="col-sm-12">
            ...
            <div class="form-group">
                ...
                <div class='input-group date' id='datetimepicker3'>
                    <form:input type='text' class="form-control required" name="dob" path="dob" required="true"/>
                ...
                <div class="row">               
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <form:select name="area_name" class="form-control required" path="area_name" required="true">
                ...
                <div class="form-group">
                  ...
                  <form:textarea name="address" class="form-control required" rows="5" placeholder="" path="address" required="true" /></textarea>
                </div>
                <div class="form-group">
                  <label>Photo Upload<small>*</small></label>
                  <form:input name="photo" class="file" type="file"  data-show-upload="false" data-show-caption="true" required="true" path="profileImage" />
                  <small>Maximum upload file size: 12 MB</small>
                </div>
                <div class="form-group">
                  <label>Photo ID Proof Upload<small>*</small></label>
                  <form:input name="proof" class="file" type="file"  data-show-upload="false" data-show-caption="true" required="true" path="idProof" />
                  <small>Maximum upload file size: 12 MB</small>
                </div>
                   <div class="row">
                ...
                <div class="form-group">
                  ...
                  <button type="submit" class="btn btn-block btn-dark btn-theme-colored btn-sm mt-20 pt-10 pb-10" formaction="/unfoldhappiness_user/volunteer/saveVol">Apply Now</button>
                </div>
              </form:form>
              <!-- Job Form Validation-->
