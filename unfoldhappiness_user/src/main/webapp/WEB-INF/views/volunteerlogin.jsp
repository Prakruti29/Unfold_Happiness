      ...
      <div class="container" id="main" >
        <div class="row">
          <div class="col-md-6 col-md-push-2">
           ...
           <center> <p id="reg">New Volunteer?  &nbsp;&nbsp;&nbsp;<a href="/unfoldhappiness_user/volunteer/registerVol" class="text-theme-colored font-weight-600 font-14">REGISTER</a></p></center>
            <form method="post" action="/unfoldhappiness_user/user/volloggingIn" modelAttribute="vollog" enctype="multipart/form-data">
              <div class="row" id="u1">
