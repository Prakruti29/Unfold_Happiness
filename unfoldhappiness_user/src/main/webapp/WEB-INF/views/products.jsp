                ...
                <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <select name="ngo" class="form-control">
                        ...
                        <option value="Jivdaya Trust">Jivdaya Trust</option>
                        <option value="Sajag">Sajag</option>
                       <option value="Mahavir Trust">Mahavir Trust</option>
              ...
              <div class="col-sm-6 col-md-4 col-lg-3 mb-30">
                <div class="product">
                  ...
                  <div class="product-thumb"> 
                    <img alt="" src="/unfoldhappiness_user/resources/images/product/waterpot.jpg" class="img-responsive img-fullwidth">
                    <div class="overlay">
                      <div class="btn-add-to-cart-wrapper">
                        
                      </div>
                      <div class="btn-product-view-details">
                        <a class="btn btn-default btn-theme-colored btn-sm btn-flat pl-20 pr-20 btn-add-to-cart text-uppercase font-weight-700" href="/unfoldhappiness_user/product/details" target="_blank">View details</a>
                      </div>
                    </div>
                  </div>
                  <div class="product-details text-center">
                    <a href="#"><h5 class="product-title">Water Pot</h5></a>
                    
                    <div class="price"><del><span class="amount">Rs75</span></del><ins><span class="amount">Rs75</span></ins></div>
                  </div>
                </div>
              </div>
               <div class="col-sm-6 col-md-4 col-lg-3 mb-30">
                <div class="product">
                  <span class="tag-sale">Sale!</span>
                  <div class="product-thumb"> 
                    <img alt="" src="/unfoldhappiness_user/resources/images/product/flowerpot.jpg" class="img-responsive img-fullwidth">
                    <div class="overlay">
                      <div class="btn-add-to-cart-wrapper">
                  ...
                  <div class="product-details text-center">
                    <a href="#"><h5 class="product-title">Flower Vase</h5></a>
                    
                    <div class="price"><del><span class="amount">Rs100.00</span></del><ins><span class="amount">Rs100.00</span></ins></div>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-md-4 col-lg-3 mb-30">
                <div class="product">
                  <span class="tag-sale">Sale!</span>
                  <div class="product-thumb"> 
                    <img alt="" src="/unfoldhappiness_user/resources/images/product/keychains2.jpg" class="img-responsive img-fullwidth">
                    <div class="overlay">
                      <div class="btn-add-to-cart-wrapper">
                       
                      </div>
                      <div class="btn-product-view-details">
                        <a class="btn btn-default btn-theme-colored btn-sm btn-flat pl-20 pr-20 btn-add-to-cart text-uppercase font-weight-700" href="/unfoldhappiness_user/product/productDetails" target="_blank">View detail</a>
                      </div>
                    </div>
                  </div>
                  <div class="product-details text-center">
                    <a href="#"><h5 class="product-title">Keychains</h5></a>
                   
                    <div class="price"><del><span class="amount">Rs55.00</span></del><ins><span class="amount">Rs50.00</span></ins></div>
                  </div>
                </div>
              </div>
               <div class="col-sm-6 col-md-4 col-lg-3 mb-30">
                <div class="product">
                  <span class="tag-sale">Sale!</span>
                  <div class="product-thumb"> 
                    <img alt="" src="/unfoldhappiness_user/resources/images/product/lamp.jpg" class="img-responsive img-fullwidth">
                    <div class="overlay">
                      <div class="btn-product-view-details">
                        <a class="btn btn-default btn-theme-colored btn-sm btn-flat pl-20 pr-20 btn-add-to-cart text-uppercase font-weight-700" href="/unfoldhappiness_user/product/productdetails" target="_blank">View detail</a>
                      </div>
                  ...
                  <div class="product-details text-center">
                    <a href="#"><h5 class="product-title">Lamp</h5></a>
                   
                    <div class="price"><del><span class="amount">Rs275.00</span></del><ins><span class="amount">Rs250.00</span></ins></div>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-md-4 col-lg-3 mb-30">
            ...
            <div class="products owl-carousel-4col">
              <div class="item">
                <div class="product">
                  <span class="tag-sale">Sale!</span>
                  <div class="product-thumb"> 
                    <img alt="" src="resources/images/products/1.jpg" class="img-responsive img-fullwidth">
                    <div class="overlay">
                      <div class="btn-add-to-cart-wrapper">
              ...
              <div class="item">
                <div class="product">
                  <div class="product-thumb"> 
                    <img alt="" src="resources/images/products/2.jpg" class="img-responsive img-fullwidth">
                    <div class="overlay">
                      <div class="btn-add-to-cart-wrapper">
                        <a class="btn btn-theme-colored btn-sm btn-flat pl-20 pr-20 btn-add-to-cart text-uppercase font-weight-700" href="shop-cart.html" target="_blank">Add To Cart</a>
                      </div>
              ...
              <div class="item">
                <div class="product">
                  <span class="tag-sale">Sale!</span>
                  <div class="product-thumb"> 
                    <img alt="" src="resources/images/products/3.jpg" class="img-responsive img-fullwidth">
                    <div class="overlay">
                      <div class="btn-add-to-cart-wrapper">
                        <a class="btn btn-theme-colored btn-sm btn-flat pl-20 pr-20 btn-add-to-cart text-uppercase font-weight-700" href="shop-cart.html" target="_blank">Add To Cart</a>
                      </div>
              ...
              <div class="item">
                <div class="product">
                  <div class="product-thumb"> 
                    <img alt="" src="resources/images/products/4.jpg" class="img-responsive img-fullwidth">
                    <div class="overlay">
                      <div class="btn-add-to-cart-wrapper">
                        <a class="btn btn-theme-colored btn-sm btn-flat pl-20 pr-20 btn-add-to-cart text-uppercase font-weight-700" href="shop-cart.html" target="_blank">Add To Cart</a>
                      </div>
              ...
              <div class="item">
                <div class="product">
                  <span class="tag-sale">Sale!</span>
                  <div class="product-thumb"> 
                    <img alt="" src="resources/images/products/5.jpg" class="img-responsive img-fullwidth">
                    <div class="overlay">
                      <div class="btn-add-to-cart-wrapper">
                        <a class="btn btn-theme-colored btn-sm btn-flat pl-20 pr-20 btn-add-to-cart text-uppercase font-weight-700" href="shop-cart.html" target="_blank">Add To Cart</a>
                      </div>
