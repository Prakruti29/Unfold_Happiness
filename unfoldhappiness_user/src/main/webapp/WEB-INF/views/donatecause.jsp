...
<div id="wrapper" class="clearfix">
  ...
  <!-- Start main-content -->
 <section class="divider parallax layer-overlay overlay-dark-6" data-bg-img="resources/images/bg/bg2.jpg" data-parallax-ratio="0.7">
          ...
          <div class="col-md-8">
            <div class="bg-light-transparent p-40 pb-30">
              ...
              <form id="paypal_donate_form_onetime_recurring">
                <div class="row">
                  <div class="col-md-12">
                    <img src="resources/images/payment-card-logo-sm.png" alt="">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group mb-20">
                      ...
                      <select name="items" class="form-control">
                        <option value="Kerala Flood Relief Fund">Kerala Flood Relief Fund</option>
                        <option value="Ganga Cleaning Yojna">Ganga Cleaning Yojna</option>
                        <option value="Kashmir Terrorist Attack">Kashmir Terrorist Attack</option>
                        <option value="Assam Flood Relief Fund">Assam Flood Relief Fund</option>
                      </select>
                    </div>
                  </div>
