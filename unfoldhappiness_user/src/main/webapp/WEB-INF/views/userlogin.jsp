...
<div id="wrapper" class="clearfix">
  ...
  <div class="main-content">
    ...
    <section class="inner-header divider parallax layer-overlay overlay-white-5" data-bg-img="resources/images/motivation-4330453_1920.jpg">
      <div class="container" id="main" >
        <div class="row">
          <div class="col-md-6 col-md-push-2">
           <center><h4 class="text-theme-colored font-weight-600 font-25"> LOGIN</h4></center>
            <center><hr id="hr"></center>
           <center> <p id="reg">New User?  &nbsp;&nbsp;&nbsp;<a href="/unfoldhappiness_user/user/addUser" class="text-theme-colored font-weight-600 font-14">REGISTER</a></p></center>
            <form method="post" name="login-form" class="clearfix" action="/unfoldhappiness_user/user/userloggingIn" modelAttribute="userlog">
              <div class="row" id="u1">
