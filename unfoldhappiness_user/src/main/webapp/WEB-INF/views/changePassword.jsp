        ...
        <div class="row">
          <div class="col-md-6 col-md-push-3">
            <div class="border-1px p-30 mb-0">
              ...
              <form method="post" action="/unfoldhappiness_user/user/change" modelAttribute="cpass">
                
				                
                  <div class="col-sm-12">
                    <div class="form-group">
                      <label>Old Password<small>*</small></label>
                      <input name="password" type="password" placeholder="" required="true" class="form-control" path="password">
                    </div>
                  </div>
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <input name="newpassword" class="form-control" required="true" type="password" placeholder="" path="npassword">
                    </div>
                  </div>
                <div class="col-sm-12">
                    <div class="form-group">
                      <label>Confirm New Password <small>*</small></label>
                      <input name="conpassword" class="form-control" required="true" type="password" placeholder="" path="conpassword" name="conpassword">
                    </div>
                  </div>
